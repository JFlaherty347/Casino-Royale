...
A slight modificatino that uses multiHandBlackjack.py which runs by itself, without the main menu.
This is mainly a backup in case the main menu fails so that the blackjack game can still be shown
